...
public class PalabrasAleatorias {
    ...
    private List<String> lPalabrasAleatorias = Arrays.asList("abrir", "acero", "acto", "agua", "aire", "alma", "alta", "amigo",
    ...
    public String PalabraAleatoria(){
        int indexRandom = (int)(Math.random()*(lPalabrasAleatorias.size()-1));
        String palabra = lPalabrasAleatorias.get(indexRandom);
        return palabra;
    }
}
